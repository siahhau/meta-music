...
// 主组件：乐谱库首页音乐创作者区
export function HomeForComposer({ sx, ...other }) {
  return (
    <Box
      component="section"
      sx={[
        (theme) => ({
          ...
          ...theme.mixins.bgGradient({
            images: [
              ...
              `url(${CONFIG.assetsDir}/assets/images/home/for-composer.webp)`,
            ],
          }),
          [theme.breakpoints.up('md')]: {
            ...theme.mixins.bgGradient({
              images: [`url(${CONFIG.assetsDir}/assets/images/home/for-composer.webp)`],
              sizes: ['auto 92%'],
            }),
            minHeight: 720,
          },
      ...
      <MotionViewport>
        ...
        >
          <SectionTitle
            caption="专业音乐工具"
            title="为音乐创作者"
            description="使用和弦变量和音符变体，节省创作时间，提升乐谱设计效率。"
            sx={[
              () => ({
                zIndex: 1,
